    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            ...
            <div class="owl-carousel team-carousel position-relative" style="padding: 0 30px;">
                <div class="team-item">
                    <img class="img-fluid w-100" src="../../img/pfp.jpg" alt="">
                    <div class="position-relative py-4">
                        <h4 class="text-uppercase">Jad Belassiria</h4>
                        <p class="m-0">Full-Stack dev</p>
                        <div class="team-social position-absolute w-100 h-100 d-flex align-items-center justify-content-center">
                            <!-- <a class="btn btn-lg btn-primary btn-lg-square mx-1" href="#"><i class="fab fa-twitter"></i></a> -->
                            <a class="btn btn-lg btn-primary btn-lg-square mx-1" href="https://github.com/Jad-Bel?tab=overview&from=2025-01-01&to=2025-01-01"><i class="fab fa-github"></i></a>
                            <a class="btn btn-lg btn-primary btn-lg-square mx-1" href="https://www.linkedin.com/in/jad-belassiria-16390321b/"><i class="fab fa-linkedin-in"></i></a>
                        </div>
                    </div>
                </div>
            </div>
